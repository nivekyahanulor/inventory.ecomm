	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
                ...
                <input type="text" name="verify_name" id="verify_name">
                <div class="container">
...
<h4 class="modal-title text-danger text-center">Are you sure?</h4>
			<div class="modal-body">
				<div align="center">
                        ...
                        <button id="confirm-verify" type="submit" class="btn btn-default btn-lg del-expired" >Confirm
...
$('#confirm-verify').click(function(event) {
	event.preventDefault();
    var user_account = $('#verify_name').val();
	if(user_account != ''){
		$.ajax({
				url: 'data/verify_user.php',
				type: 'post',
				dataType: 'json',
				data: {
...
// $(document).on('submit', '#check-verify', function(event) {
// 	event.preventDefault();
// 	var user_account = $('#tester').val();
